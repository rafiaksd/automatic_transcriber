...
def download_youtube_video():
    ...
    try:
        ...
        selected_index = simpledialog.askinteger("Select Quality", f"Enter the number of the quality to download (1-{len(available_streams)}):")
        ...
        if not selected_stream.is_progressive:
            ...
            if result.returncode == 0:
                ...
                print(f"Time taken:{conversion_time_took:.2f}s")
                print(f"\n✅ Final video with audio saved at: {final_output}")
            else:
